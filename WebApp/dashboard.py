...
def load_details():
	details=pd.read_csv("../WebApp/csv/patients.csv")
	return (details)
patient_details=load_details()

def load_observations():
	details=pd.read_csv("../WebApp/csv/observations.csv")
	return (details)
patient_observations=load_observations()

def load_condition():
	details=pd.read_csv("../WebApp/csv/conditions.csv")
	return (details)
patient_conditions=load_condition()

def load_allergies():
	details=pd.read_csv("../WebApp/csv/allergies.csv")
	return (details)
patient_allergies=load_allergies()

def load_careplans():
	details=pd.read_csv("../WebApp/csv/careplans.csv")
	return (details)
patient_careplans=load_careplans()

def load_devices():
	details=pd.read_csv("../WebApp/csv/devices.csv")
	return (details)
patient_devices=load_devices()

def load_suppliers():
	details=pd.read_csv("../WebApp/csv/providers.csv")
	return(details)
